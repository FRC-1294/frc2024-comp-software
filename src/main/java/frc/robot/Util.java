...
public class Util {
    ...
    public static class PIDConstants{
        ...
        public PIDConstants(double kP, double kI, double kD, double kV, double kS, double kA, double continuousInputMax, double continuousInputMin){
            mKP = kP;
            mKI = kI;
            mKD = kD;
            mKV = kV;
        ...
        public PIDConstants(double kP, double kI, double kD, double kS, double kV,double kA){
            this(kP, kI, kD, kV, kS,0,0,0);
            mIsContinuousInput = false;
        }

        public PIDConstants(double kP, double kI, double kD){
            this(kP, kI, kD, 0, 0,0,0,0);
            mIsContinuousInput = false;
        }
