...
import frc.robot.KrakenSwerveConfig;
import frc.robot.SwerveModule;
import frc.robot.constants.CompConstants;
import frc.robot.constants.SwerveConstants;

public class KrakenSwerveSubsystem extends SubsystemBase {
  ...
  public KrakenSwerveSubsystem() {
    // Populating Instance Variables

    mKinematics = KrakenSwerveConfig.SWERVE_KINEMATICS;
    mPigeon2 = new Pigeon2(KrakenSwerveConfig.PIGEON_ID,"SWERVE_ENC");
    mModules = KrakenSwerveConfig.SWERVE_MODULES;
